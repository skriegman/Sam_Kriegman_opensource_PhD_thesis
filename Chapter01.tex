...
the controller will need to carefully redistribute its computational resources to steer these additional aspects of behavior while maintaining other aspects with less computational oversight.
...
It is usually easier to achieve acceptable levels of fitness by holding the body plan fixed throughout optimization and focus solely on learning better controllers for the given body, regardless of the body's fitness potential \cite{cheney2016difficulty}.
...
By virtue of greater and greater morphological autonomy, increasingly protean machines can possess greater and greater robustness, agency and epistemic autonomy.
...
This section traces such work in literature from \citet{pask1958physical} to modern embodied machines and beyond.
