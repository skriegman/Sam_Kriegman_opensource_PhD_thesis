...
This allows increasingly protean machines to gradually distance themselves from their designer.
...
\begin{itemize}
    ...
    % The material is thus ill-specified: 
    % its properties depend on evolved developmental reactions to the current environment.
...
\begin{itemize}
    ...
    % The overall size and local surface curvature of the robot depends on its automatically determined distribution of voxel resting volumes
    % and is constrained by non-intuitive interference between neighbors that in one voxel expand and in another contract.
...
Reconfigurable organisms are assembled according to a blueprint which could be computer-generated or human-generated.
