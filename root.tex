...
approaches to robot design are becoming increasingly widespread, but they remain narrowly focused on tuning the parameters of software (neural network weights) inside an overwhelmingly static and presupposed body.
